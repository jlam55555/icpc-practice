...
{
	BYTE nnbrs[10][10];		// for non-stroke boxes number of stroke box neighbors with < 3 strokes
	...
	BYTE needStrokes[10][10];	// for stroke boxes, total strokes needed by neighbors at this level
